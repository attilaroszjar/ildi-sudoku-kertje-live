...
test('Whispers bounded quality audit 32 seeds x 3 difficulties',()=>{
  ...
  for(const seed of SEEDS){
    ...
    for(const difficulty of DIFFICULTIES){
      ...
      assert.equal(a.generation.unique,true);assert.equal(a.generation.variantEssential,true);assert.equal(a.generation.generatorFamily,'line-whispers-fresh-fill-mrv');assert.equal(a.generation.pilot,false);
  ...
  console.log('WHISPERS_GENERATOR_AUDIT '+JSON.stringify(summary));
