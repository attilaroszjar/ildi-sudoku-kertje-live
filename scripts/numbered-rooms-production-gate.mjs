...
function clueTopology(generated){
  return canonicalJson((generated.data&&generated.data.clues)||[]);
}
...
const jobs=Array.from({length:samples},(_,i)=>({seed:(0x6e720000+i*0x1f3d)>>>0}));
const rows=[];
...
console.log('NUMBERED_ROOMS_PRODUCTION_GATE '+JSON.stringify({samples,perSampleTimeoutMs,concurrency,report}));
console.log('NUMBERED_ROOMS_PRODUCTION_GATE:'+(pass?'PASS':'FAIL'));
